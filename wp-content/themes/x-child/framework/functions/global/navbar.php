  ...
  function x_output_primary_navigation() {
    ...
    if ( x_is_one_page_navigation() ) {
      ...
      wp_nav_menu( array(
        ...
        'container'      => false,
        'menu_class'     => 'x-nav x-nav-scrollspy x-column x-sm x-2-3',
        'link_before'    => '<span>',
        'link_after'     => '</span>'
      ) );
      ...
      wp_nav_menu( array(
        'theme_location' => 'primary',
        'container'      => false,
        'menu_class'     => 'x-nav x-nav-menu x-column x-sm x-2-3',
        'link_before'    => '<span>',
        'link_after'     => '</span>'
      ) );
      ...
      echo '<ul class="x-nav x-nav-menu x-column x-sm x-2-3"><li><a href="' . home_url( '/' ) . 'wp-admin/nav-menus.php">Assign a Menu</a></li></ul>';
...
if ( ! function_exists( 'x_navbar_social_networks_item' ) ) :
  function x_navbar_social_networks_item( $items, $args ) {

    if ( x_get_option( 'x_header_search_enable' ) == '1' ) {
      if ( $args->theme_location == 'primary' ) {
        $items .= '</ul><ul class="x-nav x-nav-social x-column x-sm x-1-3"><li><a href="https://www.facebook.com/thedailymilk.nl" class="facebook" title="Facebook" target="_blank"><i class="x-icon-facebook-square" data-x-icon="" aria-hidden="true"></i></a></li><li><a href="https://twitter.com/thedailymilk_nl" class="twitter" title="Twitter" target="_blank"><i class="x-icon-twitter-square" data-x-icon="" aria-hidden="true"></i></a></li>';
      }
    }
  ...
  add_filter( 'wp_nav_menu_items', 'x_navbar_social_networks_item', 9998, 2 );
endif;
